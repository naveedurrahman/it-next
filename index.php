        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
          <ul>
            ...
            <li data-index="rs-181" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="images/it_service/slide2.jpg" data-rotate="0" data-saveperformance="off" data-title="Easy To Use & Customize" data-description="">
              ...
              <!-- LAYER NR. 2 -->
              <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" id="slide-18-layer-11" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['0','0','0','0']" data-fontsize="['70','70','70','35']" data-lineheight="['70','70','70','50']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:[-100%];z:0;rZ:35deg;sX:1;sY:1;skX:0;skY:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000" data-splitin="chars" data-splitout="none" data-responsive_offset="on" data-elementdelay="0.05" style="z-index: 6; white-space: nowrap;">Fast & Affordable </div>
              <!-- LAYER NR. 3 -->
...
<div class="section padding_layout_1">
  <div class="container">
    ...
    <div class="row">
      ...
      <?php
      $result = mysqli_query($connect, "select * from choose_us");
      while ($rows = mysqli_fetch_assoc($result)) {
      ?>
        <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
          <div class="full text_align_center margin_bottom_30">
            <div class="center">
              <div class="icon"> <img src="images/it_service/<?php echo $rows['icon']; ?>" alt="#" /> </div>
            </div>
            <h4 class="theme_color"><?php echo $rows['title']; ?></h4>
  ...
  <div class="container">
    ...
    <div class="row counter">
      ...
      <div class="col-md-8">
        <div class="row">
          <?php
          $result = mysqli_query($connect, 'select * from our_feedback');
          while ($row = mysqli_fetch_assoc($result)) {

          ?>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
              <div class="text_align_right"><i class="<?php echo $row['ft_icon']; ?>"></i></div>
              <div class="text_align_right">
                <p class="counter-heading text_align_right"><?php echo $row['title']; ?></p>
              </div>
              <h5 class="counter-count"><?php echo $row['n_person']; ?></h5>
            </div>
...
<div class="section padding_layout_1">
  <div class="container">
    ...
    <div class="row">
      <?php
      $result = mysqli_query($connect, 'select * from our_blog');
      while ($row = mysqli_fetch_assoc($result)) {
      ?>
        <div class="col-md-4">
          <div class="full blog_colum">
            <div class="blog_feature_img"> <img src="images/it_service/<?php echo $row['image']; ?>" alt="#" /> </div>
            <div class="post_time">
              <p><i class="fa fa-clock-o"></i> <?php echo $row['date']; ?> ( <?php echo $row['username']; ?> )</p>
            </div>
