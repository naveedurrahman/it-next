        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">ACCORDION FORM</h2>
                </div>
                <div class="card-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                       <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <input class="input--style-6" type="text" name="collapse">
                            </div>
                        </div>
                        <div class="form-row">
                            <div>
                                <button class="btn btn--radius-2 btn--blue-2" type="submit" name="done">Add Accordion</button>
                                <span>
                                    <?php
                                    include("../db.php");
                                    if (isset($_POST['done'])) {
                                        ...
                                        $collapse = $_POST['collapse'];
                                            ...
                                            mysqli_query($connect, "insert into some_accordion values('','$icon','$title','$detail','$collapse')");
