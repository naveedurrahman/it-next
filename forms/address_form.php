            ...
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form action="#" method="POST">
                        ...
                        <div class="form-row">
                            <div>
                                <button class="btn btn--radius-2 btn--blue-2" type="submit" name="done">Add Address</button>
                                <span>
                                    <?php
                                    include("../db.php");
                                    if (isset($_POST['done'])) {
                                        ...
                                        $email = $_POST['email'];
                                            ...
                                            mysqli_query($connect, "insert into address values('','$title','$text','$address','$phone','$email')");
