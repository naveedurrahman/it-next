            ...
            <div class="card card-6">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-row">
                            <div>
                                <button class="btn btn--radius-2 btn--blue-2" type="submit" name="done">About Service</button>
                                <span>
                                    <?php
                                    include("../db.php");
                                    if (isset($_POST['done'])) {
                                        ...
                                        $detail = $_POST['detail'];
                                            ...
                                            mysqli_query($connect, "insert into about_services values('','$icon','$title','$detail')");
