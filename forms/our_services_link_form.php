        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">SERVICES LINKS</h2>
                </div>
                <div class="card-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div>
                                <button class="btn btn--radius-2 btn--blue-2" type="submit" name="done">Add Service Link</button>
                                <span>
                                    <?php
                                    include("../db.php");
                                    if (isset($_POST['done'])) 
                                    {
                                        ...
                                        $link = $_POST['link'];
                                            ...
                                            mysqli_query($connect, "insert into our_services_links values('','$title','$link')");
