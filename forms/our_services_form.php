            ...
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div>
                                <button class="btn btn--radius-2 btn--blue-2" type="submit" name="done">Add Service</button>
                                <span>
                                    <?php
                                    include("../db.php");
                                    if(isset($_POST['done'])){
                                        ...
                                        {
                                            mysqli_query($connect,"insert into our_services values('','$image_name','$title','$excerpt','$detail')");
