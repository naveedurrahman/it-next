        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Need file recovery?</h2>
                </div>
                <div class="card-body">
                    <form action="#" method="POST">
                        ...
                        <div class="form-row">
                            <div>
                                <button class="btn btn--radius-2 btn--blue-2" type="submit" name="done">Add details</button>
                                <span>
                                    <?php
                                    include("../db.php");
                                    if (isset($_POST['done'])) {
                                        ...
                                        mysqli_query($connect, "insert into file_recovery values('','$title','$detail')");
